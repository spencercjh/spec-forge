...
type GenerateOptions struct {
	...
	ExcludeRoutes        []string      // Exact route paths to exclude from the generated spec
	ExcludeRoutePrefixes []string      // Route path prefixes to exclude from the generated spec
}
